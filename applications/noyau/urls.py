...
urlpatterns = [
    ...
    path('offline/', views.vue_offline, name='offline'),
    ...
    path("public/", views.public_announcements, name="public_announcements"),
    path("personal/", views.personal_announcements, name="personal_announcements"),
